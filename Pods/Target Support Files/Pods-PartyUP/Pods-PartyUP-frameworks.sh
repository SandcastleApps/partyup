...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-PartyUP/AWSCognito.framework"
  ...
  install_framework "Pods-PartyUP/Bolts.framework"
  install_framework "Pods-PartyUP/DACircularProgress.framework"
  install_framework "Pods-PartyUP/FBSDKCoreKit.framework"
  install_framework "Pods-PartyUP/FBSDKLoginKit.framework"
  install_framework "Pods-PartyUP/Flurry_iOS_SDK.framework"
  install_framework "Pods-PartyUP/INTULocationManager.framework"
  install_framework "Pods-PartyUP/Instructions.framework"
  install_framework "Pods-PartyUP/KeychainAccess.framework"
  install_framework "Pods-PartyUP/LMGeocoder.framework"
  install_framework "Pods-PartyUP/LocationPickerViewController.framework"
  install_framework "Pods-PartyUP/MarqueeLabel.framework"
  install_framework "Pods-PartyUP/PBJVision.framework"
  install_framework "Pods-PartyUP/SCLAlertView.framework"
